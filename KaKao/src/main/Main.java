...
public class Main {
	//메인 설정
	final String HOST_URL = "https://kox947ka1a.execute-api.ap-northeast-2.amazonaws.com/prod/users";
	final String token = "bd3c0c5b9600175d3bb4bc60b3d4da81";
	String auth_key = "";
	
	
	public static void main(String[] args) {
		Main main = new Main();
		JSONObject startResult = main.startApi(1);
		main.auth_key = startResult.getString("auth_key");
				
		JSONObject bikesMap = main.actionAPI("locations", "GET", null);
		JSONObject trucksMap = main.actionAPI("trucks", "GET", null);
		...
		JSONObject resultMap = main.actionAPI("simulate" , "PUT", commands);
		
		JSONObject scoreMap = main.actionAPI("score", "GET", null);
	}
